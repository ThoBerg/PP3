...
<svg xmlns="http://www.w3.org/2000/svg"
    ...
    <title>Meine Grafik</title>
    <desc>Linie, Kreis und Rechteck</desc>
...
Beim Wechsel der documentclass zu book ändert sich das Layout des Dokuments: Es werden Kapitel statt Abschnitte verwendet, das Titelblatt und die Seitenaufteilung folgen einem buchtypischen Format.</details>
<details>
    <summary>What changes in your pdf, if you add <code>\section{Intro}</code> after <code>\maketitle</code></summary>
Durch das Einfügen von \section{Intro} erscheint im PDF eine neue, automatisch nummerierte Überschrift „Intro“, und der folgende Text wird diesem Abschnitt zugeordnet.
</details>
